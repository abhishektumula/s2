...
*   **Description:** In the `socket.onmessage` event handler, the client currently assigns the logged-in user's name to *every* incoming message received from the WebSocket server.
